<template>
        <h1>Forum</h1>
        <RouterLink class="btn btn-primary mb-3" to="/forumPost"><i class="bi bi-plus"></i> 新增</RouterLink>
        <div class="container">
    ...
    <div class="col-3">
      ...
      <ul class="list-group list-group-flush">
        ...
        <li class="list-group-item" style="text-align: right;"><i class="bi bi-hand-thumbs-up"></i> {{ post.likeCount }} <i class="bi bi-hand-thumbs-down-fill" ></i> {{ post.unLikeCount }}</li>
...
<script setup>
     ...
     const datas = reactive({
        ...
        const API_URL = `${import.meta.env.VITE_API_JAVAURL}pages/ajax/PetArticleOrderView/find`
