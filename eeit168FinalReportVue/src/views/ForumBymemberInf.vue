    ...
    <div class="main-content">
        ...
        <div class="container">
            <div style="margin-top: 0px; display: flex; justify-content:space-between; align-items: center;">
                ...
                <span class="" v-if="isMember">
                    <RouterLink class="btn btn-primary mb-3" to="/forum/add" style="margin-top: 20px;"><i
                            class="bi bi-plus"></i> 新討論</RouterLink>
                </span>
            </div>
            <div class="d-flex justify-content-center" style="margin-top:20px;">
                ...
                <div class="card-list">
                    <div class="row row-cols-1 row-cols-md-3 g-0 ">
                        <div class="card border-primary text-dark bg-light mb-3 border border-3" style="width: 18rem;  margin: 10px;" v-for="(post, index) in posts"
                            :key="index">
                            <img :src="post.main" class="card-img-top custom-image" alt="..." />
                            <div class="card-body">
                                <RouterLink to="/forumpost" class="custom-link">
                                    <h5 class="card-title" @click="selectId(post.id)"
                            ...
                            <ul class="list-group list-group-flush">
                                ...
                                <li class="list-group-item" style="text-align: centers">
                                    ...
                                    <div style="float: right;"><i class="bi bi-hand-thumbs-up"></i> {{ post.likeCount }}
                                        &nbsp
                                ...
                                <span v-if="isMember">
                                    <li class="list-group-item d-flex justify-content-between">
                                        ...
                                        <button class="btn btn-danger" @click="deleteHandler(post.id)"><i
