<template>
  ...
  <span style="flex: 1;">狀態修改時間: {{limitText(item.stateChangeTime, 16)  }}</span>
    <span style="flex: 1; text-align: right; ;">訂單ID: {{ item.orderDetailsId }}&nbsp;&nbsp;&nbsp;&nbsp;</span>
</button>
</h2>
      <div
        :id="'collapse' + index"
      ...
      >
      <div class="dropdown"  style="display: flex ; justify-content: space-between; margin-bottom: -20px; margin-top: 13px; margin-left: 20px;margin-right: 10px;">
            <strong style="font-size: 20px; flex: 1;">商品編號:{{item.productId}} 商品名稱:{{ item.name }}</strong>
            ...
            <button
                ...
                aria-expanded="false"
                style="width: 150px;height: 40px; flex: 0;"
  ...
  <span style="margin-right: 30px;">{{ "訂單狀態: " + item.state }}</span>     
</div>
<div style="display: flex; justify-content: space-between; margin-bottom: 10px;">
<span style="margin-left: 20px;">{{ "訂購人: " + item.lastName +" 先生/小姐" }}</span> 
